...
```
cd existing_repo
git remote add origin https://gitlab.com/EstelleDab/medialogue.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/EstelleDab/medialogue/-/settings/integrations)
